...
전설리스트=[]
히든리스트=[]
꼭가야할캐릭리스트=["레필제한","레베카제한","시노부제한","아인제한","애넬제한","카타쿠리제한","크로커제한","킹제한","검수초월","나미초월","도플초월","로빈초월","로우초월","루치초월","루피초월","바질초월","브룩초월","사보초월","상디","샹크스(초월)","스네이크맨","시라호시","아오키지(초월)","아카이누(초월)","야마토초월","우솝초월","조로초월","징베초월","쵸파초월!","키드초월","키자루","태시기초월","프랑키초월","중력검","거프ㅋㅋ불멸","드래곤불멸","레일리불멸","로져불멸","빅맘불멸","센고쿠불멸","가반불멸","시키불멸","제트불멸","카이도불멸","흰수염불멸","미호크영원","버기영원","비비영원","에이스영원","오뎅영원","카벤영원","핸콕영원"]
...
꼭갈캐=Button(ORD,width=30,height=4, fg="black", bg="white", text="눌러서 결과 확인",command=necessary)
